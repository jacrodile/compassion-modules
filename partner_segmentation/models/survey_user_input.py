...
class SurveyUserInput(models.Model):
    ...
    def _get_answer_as_array(self):
        ...
        """
        options_dict = defaultdict(lambda: [])  # Store options for multiple_choice questions
        ...
        for user_input_line in self.user_input_line_ids:
            ...
            if question_type == "matrix":
                ...
                if (question.comment_count_as_answer and
                        user_input_line.answer_type == "text_box"):
