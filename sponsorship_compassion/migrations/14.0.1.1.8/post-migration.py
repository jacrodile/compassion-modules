...
def migrate(env, version):
    ...
    for contract in contracts:
        ...
        _logger.info(
            f"Migrating {global_id} child on {contract.gmc_commitment_id} contract."
        )
            ...
            for commitment in commitments:
                ...
                if commitment.get("CommitmentType") == "Sponsor":
                    ...
                    if new_gmc_id and new_gmc_id != contract.gmc_commitment_id:
                        err_message = (
                            f"Sponsorship {contract.display_name} has a different commitment_id "
