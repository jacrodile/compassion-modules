...
class PartnerSponsorshipReport(models.Model):
    ...
    sr_nb_b2s_letter = fields.Integer(
        "Number of letters to sponsor", compute="_compute_b2s_letter"
    )
    sr_nb_s2b_letter = fields.Integer(
        "Number of letters to beneficiary", compute="_compute_s2b_letter"
    )
